...
class fusion3(nn.Module):
    def __init__(self, num_cam, Rworld_shape, hidden_dim=128):
        ...
        self.sampler1 = LocalSimGuidedSampler(in_channels=128, groups=self.sampler_groups[2], kernel_size=self.sampler_kernel_size[1], local_window=self.sampler_local_windows[2], direction_feat='sim_sim', dilation=2)
        self.sampler2 = LocalSimGuidedSampler(in_channels=128, groups=self.sampler_groups[2], kernel_size=self.sampler_kernel_size[1], local_window=self.sampler_local_windows[1], direction_feat='sim_sim', dilation=2)
